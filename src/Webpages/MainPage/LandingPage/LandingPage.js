    ...
    return (
        <section className='landing-page'>
            <div className='landing-page-text-wrap'>
                <div className='fade-in' style={{transitionDelay: '100ms', fontSize: 'clamp(var(--fz-sm),5vw,var(--fz-md))'}}><h1>Hey Yall, </h1></div>
                ...
                <div style={{transitionDelay: '500ms'}}>
                    <Button className='image-border' variant='outlined' sx={{margin: '30px 0px 0px 4px', color: 'var(--section-title-color)', borderColor: 'var(--section-title-color)'}}>
